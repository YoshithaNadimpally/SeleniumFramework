...
public class SeleniumUtil {
    ...
    public void click(WebDriver driver, By locator) {
        wait_until_ElementIs_Visible(driver, locator).click();
    ...
    public void sendKeys(WebDriver driver, By locator , String data) {
        wait_until_ElementIs_Visible(driver, locator).sendKeys(data);
        waitForPageToLoad(driver);
    }
    ...
    public String getText(WebDriver driver, By locator) {
        return wait_until_ElementIs_Visible(driver, locator).getText();
    }
